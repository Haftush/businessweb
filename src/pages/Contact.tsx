  ...
  const socialMedia = [
    {
      ...
      name: "Facebook",
      link: "https://www.facebook.com/haftu.584",
  ...
  const faqs = [
    {
      ...
      answer:
        "I respond to all inquiries within 24 hours, usually much faster. For urgent projects, feel free to reach me directly on WhatsApp.",
    },
    {
      question: "Do you work with international clients?",
      answer:
        "Yes! I work with clients from all over the world. All communication can be done through WhatsApp, Telegram, or email.",
    },
    {
      question: "What information should I provide?",
      answer:
        "The more details, the better! Include your project goals, desired features, timeline, budget, and any design preferences.",
    },
    {
      question: "Can we schedule a call?",
      answer:
        "Absolutely! After initial contact, we can schedule a WhatsApp or Telegram call to discuss your project in detail.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {contactMethods.map((method, index) => (
              ...
              >
                <div
                  className={`${method.color} text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4`}
                >
                  {method.icon}
                </div>
          ...
          {/* Quick Info in 2 columns */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {quickInfo.map((info, index) => (
              <div
                key={index}
                className="bg-gray-50 p-6 rounded-lg flex items-center gap-4"
              >
                {info.icon}
                <div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-primary to-primary/90 rounded-2xl p-12 text-center text-white">
            ...
            <p className="text-xl text-gray-200 mb-8">
              I'm available for freelance projects and consulting. Let's create
